...
Ap = [ZapV,    1, 0, ZdpV*(w_n^2);Ma,    Mq, 0, Md*(w_n^2);0, 0, -2*eta*w_n, -(w_n^2);0, 0, 1, 0];
Bp = [0;0;1;0];
Cp = [ZdpV*V_fps, 0, 0, ZdpV*V_fps*(w_n^2); 0, 1, 0, 0];
...
Ac = [0, 0;K_q*a_q, 0];
Bc1 = [-a_z*K_a, 0; -a_q*K_a*K_q, -a_q*K_q];
Bc2 =  [a_z*K_a; a_q*K_a*K_q];
Cc = [K_q, 1];
Dc1 = [-K_a*K_q, -K_q];
Dc2 = [K_a*K_q];
